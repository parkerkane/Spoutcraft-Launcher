...
public class ModPackYML {
    ...
    public static void updateModPackYML(boolean doUpdate) {
        if (doUpdate || !updated) {
            synchronized (key) {
                ...
                YmlUtils.downloadYmlFile(ModPackListYML.currentModPack + "/" + MODPACK_YML,
                    FALLBACK_URL,
                    getModPackYMLFile());
    ...
    public static String getModPackIcon() {
        return new File(ModPackListYML.currentModPackDirectory,
            "resources" + File.separator + ModPackListYML.getIconName()).getAbsolutePath();
    }

    public static String getModPackLogo() {
        return new File(ModPackListYML.currentModPackDirectory,
            "resources" + File.separator + "logo.png").getAbsolutePath();
    }

    public static String getModPackFavIcon() {
        return new File(ModPackListYML.currentModPackDirectory,
            "resources" + File.separator + "favicon.png").getAbsolutePath();
    }

    public static String getModInfoUri() {
        final File file = new File(ModPackListYML.currentModPackDirectory,
            "resources" + File.separator + "modinfo.html");

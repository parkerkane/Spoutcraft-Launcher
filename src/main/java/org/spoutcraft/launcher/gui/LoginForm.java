...
public class LoginForm extends JFrame implements ActionListener, DownloadListener, KeyListener, WindowListener {
    ...
    JButton modsFolderButton = new JButton("Mod Folder");
    ...
    public LoginForm() {
        ...
        modsFolderButton.setFont(new Font("Arial", Font.PLAIN, 11));
        modsFolderButton.setOpaque(false);
        modsFolderButton.addActionListener(this);
        ...
        JLabel purchaseAccount = new HyperlinkJLabel("<html><u>Need a minecraft account?</u></html>",
        ...
        login.setBounds(473, 362, 372, 120);
        ...
        modsButton.setBounds(15, 60, 93, 23);
        modsFolderButton.setBounds(15, 86, 93, 23);
        ...
        loginPane.add(modsFolderButton);
        ...
        modsFolderButton.setEnabled(false);
        setResizable(false);
    ...
    public void loadLauncherData() {
        ...
        if (SettingsUtil.getModPackSelection() != null) {
            ...
            setTitle("Ph3lltopia Launcher - No Modpack Selected");
        }
    }
    ...
    public void updateBranding() {
        ...
        SwingWorker<Object, Object> updateThread = new SwingWorker<Object, Object>() {
            ...
            protected void done() {
                ...
                setTitle(String.format("Ph3lltopia Launcher - %s - (%s)",
                    Main.build,
    ...
    public void setModLoaderEnabled() {
        ...
        modsFolderButton.setEnabled(true);

//        Util.log("modinfo uri: " + ModPackYML.getModInfoUri());

        showWebpage(ModPackYML.getModInfoUri());
    }
                        ...
                        if (!password.isEmpty()) {
                            ...
                            if (i == 1) {
                                ...
                                if (!Main.isOffline) {
                                    ...
                                    ImageUtils.drawCharacter(contentPane,
                                        this,
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        } else if (eventId.equals(modsFolderButton.getText())) {
            GameUpdater.modsDir.mkdirs();

            open(GameUpdater.modsDir);
    ...
    public void doLogin(final String user, final String pass, final boolean cmdLine) {
        ...
        this.modsFolderButton.setEnabled(false);
                    ...
                    if (rememberCheckbox.isSelected()) {
                        ...
                        if (digest == null) {
                            ...
                            usernames.put(gameUpdater.user,
                                new UserPasswordInformation(digest.digest(password.getBytes())));
                        }
                    }
                    writeUsernameList();
                }
    ...
    public void runGame() {
        ...
        int result = (Main.isOffline)
                     ? launcher.runGame(null, null, null, null)
...
//        showWebpage("http://dl.dropbox.com/u/2052749/ph3ll/web/index.html");
    ...
    private void showWebpage(String url) {
        tumblerFeed = new TumblerFeedParsingWorker(editorPane, url);
        tumblerFeed.execute();
    }
    ...
    public void windowClosed(WindowEvent e) {
        if (success == LauncherFrame.ERROR_IN_LAUNCH) {
            Util.log("Exiting the Ph3lltopia Launcher");
            System.exit(0);
        }
    }

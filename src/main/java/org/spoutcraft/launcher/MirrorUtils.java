...
public class MirrorUtils {
    ...
    public static final  String[] MIRRORS_URL = {"http://dl.dropbox.com/u/2052749/ph3ll/mirrors.yml"};
    ...
    public static String getMirrorUrl(String mirrorURI, String fallbackUrl, DownloadListener listener) {
        Util.log("MirrorUtils.getMirrorUrl");
        Util.log("mirrorURI = " + mirrorURI);
        Util.log("fallbackUrl = " + fallbackUrl);
        ...
        try {
            ...
            while (!isFinished) {
                while (iterator.hasNext()) {
                    ...
                    if (count > random) {
                        String mirror = (!url.contains("github.com"))
                                        ? "http://" + url + "/" + mirrorURI
                                        : "https://" + url + "/" + mirrorURI;
